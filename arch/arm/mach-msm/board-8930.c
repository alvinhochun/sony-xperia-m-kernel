...
//MTD-SW3-PERIPHERAL-OwenHuang-NFC_Porting-00+{
...
static void __init reserve_rtb_memory(void)
{
	...
	printk(KERN_ERR "%s : size = 0x%08X\n", __func__, (int)msm8930_rtb_pdata.size);    //BSP-LC-Show_Reserve_Info-00 +
#endif
}
...
static void __init reserve_pmem_memory(void)
{
	...
	printk(KERN_ERR "%s : size = 0x%08X\n", __func__, (int)msm_contig_mem_size);    //BSP-LC-Show_Reserve_Info-00 +
#endif /*CONFIG_ANDROID_PMEM*/
}
				      ...
				      unsigned long size)
{
	...
	printk(KERN_ERR "%s : size = 0x%08X\n", __func__, (int)size);    //BSP-LC-Show_Reserve_Info-00 +
}
...
static void __init msm8930_reserve_fixed_area(unsigned long fixed_area_size)
{
	...
	printk(KERN_ERR "%s : start = 0x%08X, size = 0x%08X\n", __func__, (int)reserve_info->fixed_area_start, (int)reserve_info->fixed_area_size);    //BSP-LC-Show_Reserve_Info-00 +
...
static void __init reserve_cache_dump_memory(void)
{
	...
	printk(KERN_ERR "%s : size = 0x%08X\n", __func__, (int)total);    //BSP-LC-Show_Reserve_Info-00 +
}
#else
static void __init reserve_cache_dump_memory(void) { }
#endif
...
static struct platform_device *common_devices[] __initdata = {
	...
	/* &msm8960_device_qup_i2c_gsbi9, */ /* MTD-BSP-VT-GSBI-00- */
...
/*MTD-SW-PERIPHERAL-CH-KEY-01++[*/
	gpio_tlmm_config( GPIO_CFG( 47, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA ), GPIO_CFG_ENABLE );
	gpio_tlmm_config( GPIO_CFG( 48, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA ), GPIO_CFG_ENABLE );
/*MTD-SW-PERIPHERAL-CH-KEY-01++]*/
	gpio_tlmm_config( GPIO_CFG( 106, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA ), GPIO_CFG_ENABLE );
	gpio_tlmm_config( GPIO_CFG( 107, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA ), GPIO_CFG_ENABLE );
