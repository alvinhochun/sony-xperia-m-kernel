...
#define VER_HOST_BSP_VERSION     "172136"          //(5 digits, Dec.).
#define VER_HOST_PLATFORM_NUMBER "41"            //(2 digits, Dec.). i.e. 2.0/2.1(Eclair);2.2(Froyo) ...
#define VER_HOST_BRANCH_NUMBER   "21"            //(2 digits, Dec.)
